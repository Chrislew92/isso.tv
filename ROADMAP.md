...
- `P1-08`: der zonenabhängige Kamerapass hält die Linse im Flur zur Korridormitte, verhindert den alten schwarzen Wandclip und führt hinter 353L stabil ins Hafengelände. Das neue ⚙-Menü steuert Kameratempo von 35–140 % sowie `AUTO`, `HOCH` und `SPARSAM`; Werte bleiben lokal erhalten und verändern Orbit-Speed, DPR und Adaptive-DPR unmittelbar. Freie geometrische Kamera-Kollision bleibt offen.
- `P1-09`: blockiertes oder festhängendes Browseraudio kann Untertitel nicht mehr dauerhaft als HUD stehen lassen; ein 6,8-Sekunden-Failsafe räumt die Zeile auf. Ein lokal prozedural erzeugtes Regen-/Tieftonbett blendet jetzt weich zwischen Wohnung, Flur, Vordach und Hafen; der gemeinsame `TON`-Schalter steuert Atmosphäre und Sprache. Der Gait löst pro Halbzyklus eigene Hufimpulse mit zonenabhängiger Tonhöhe und Sprintintensität aus. Tür, Donkey-Connection, Rollwagen, Bahnhof und Signalwerk besitzen unterscheidbare Weltklänge. Produzierte Varianten, Mixoptionen und Film-/Spiel-Crossfade bleiben offen.
