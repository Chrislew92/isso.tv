...
| Samples | 180 Frames |
| FPS | 55,8 |
| durchschnittliche Framezeit | 17,93 ms |
| p95 Framezeit | 18,3 ms |

Gemessen wurde lokal im In-App-Browser in der spielbaren Fährbude nach beendetem Film-/Aufstehübergang. `PerformanceProbe` schreibt das Ergebnis ausschließlich als Diagnoseattribut an `.realtime-world`; es verändert keinen Spielzustand.
